      ...
      <div className="max-w-7xl mx-auto py-7 px-4 md:px-8 lg:px-10">
        ...
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-1">
            <Calendar size={20} />
            <h4 className="font-medium text-gray-600">{tripData.duration}</h4>
          </div>
          <div className="flex items-center gap-1">
            <Wallet size={20} />
            <h4 className="font-medium text-gray-600">{tripData.budget}</h4>
          </div>
          <div className="flex items-center gap-1">
            <Users size={20} />
            <h4 className="font-medium text-gray-600">{tripData.group_size}</h4>
          </div>
        </div>
      </div>
